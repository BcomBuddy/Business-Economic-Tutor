...
const Chat: React.FC = () => {
  const { chatMessages, addChatMessage, dispatch } = useEconTutor();
...
Practice Question: You notice declining productivity in your team. Using motivation theories, develop a comprehensive plan to re-engage your employees and improve performance.`;
      ...
      response = `Business Economics

I'm EconTutor, your AI assistant for Business Economics topics. I can help you understand key concepts in:

Microeconomics:
• Demand and Supply - Market forces and price determination
• Market Structures - Perfect competition, monopoly, oligopoly
• Consumer Behavior - Utility maximization and choice theory
• Production Theory - Cost analysis and profit maximization

Macroeconomics:
• GDP and Economic Growth - Measuring economic performance
• Inflation and Unemployment - Economic indicators
• Fiscal and Monetary Policy - Government economic interventions
• International Trade - Global economic relationships

Business Applications:
• Cost-Benefit Analysis - Decision-making frameworks
• Pricing Strategies - Market-based pricing decisions
• Investment Analysis - Capital budgeting and risk assessment
• Market Research - Understanding consumer demand

Economic Environment:
• Business Cycles - Economic fluctuations and trends
• Economic Indicators - Leading, lagging, and coincident indicators
• Global Economics - International trade and finance
• Economic Forecasting - Predicting future economic conditions

Feel free to ask specific questions about any economics topic, and I'll provide structured explanations with examples!

Key Takeaways:
• Business Economics covers both micro and macro perspectives
• Understanding market forces helps in better business decision-making
• Real-world economic examples make concepts more applicable

Practice Question: A coffee shop is considering raising prices by 15%. The price elasticity of demand for coffee is -0.8. Calculate the expected change in quantity demanded and analyze the impact on total revenue.`;
    }
      ...
      <div className={`mb-6 flex items-center justify-between p-4 bg-gradient-to-r from-[#4A6FA5]/5 to-[#3d5a8c]/5 dark:from-[#4A6FA5]/10 dark:to-[#3d5a8c]/10 ${isFullscreen ? 'rounded-none border-b border-gray-200 dark:border-gray-700' : 'rounded-xl border border-gray-200 dark:border-gray-700'}`}>
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">Get instant help with Business Economics concepts</p>
          </div>
        </div>
          ...
          {filteredMessages.length === 0 && chatMessages.length === 0 && (
            <div className="text-center py-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
                {[
                  { text: "Explain demand and supply", icon: Target, color: "from-blue-500 to-blue-600" },
                  { text: "What is price elasticity?", icon: Users, color: "from-green-500 to-green-600" },
                  { text: "Types of market structures", icon: Building, color: "from-purple-500 to-purple-600" },
                  { text: "Monopoly vs competition", icon: Award, color: "from-orange-500 to-orange-600" },
                  { text: "GDP and inflation", icon: BookOpen, color: "from-indigo-500 to-indigo-600" },
                  { text: "Cost-benefit analysis", icon: BarChart3, color: "from-pink-500 to-pink-600" }
          ...
          <div className="flex items-end space-x-3">
            <div className="flex-1 relative">
              <textarea
                ...
                placeholder="Ask about demand, supply, market structures, or any economics topic..."
