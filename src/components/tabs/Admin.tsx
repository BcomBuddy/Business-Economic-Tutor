...
const Admin: React.FC = () => {
  const { lessons, questions, cases, dispatch } = useEconTutor();
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-[#4A6FA5] focus:border-transparent"
                      rows={4}
                      defaultValue="You are EconTutor, an expert Business Economics tutor. Use clear steps, short paragraphs, everyday examples, and simple diagrams (text) when helpful. Structure with headings and bullet points. End every response with: (1) Key economic concepts, (2) One practice question."
                    />
                  </div>
                </div>
              </div>
